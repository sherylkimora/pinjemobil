...
$query = "SELECT peminjaman.*, member.nama_member, mobil.nama_mobil, mobil.nomor_polisi
          FROM peminjaman
          LEFT JOIN member ON peminjaman.id_member = member.id_member
          LEFT JOIN mobil ON peminjaman.id_mobil = mobil.id_mobil
          WHERE peminjaman.status_transaksi = 'Menunggu Cek Akhir'
...
<head>
    <title>Cek Kondisi Akhir - Pinjem Mobil</title>
    ...
    <div class="main">
        <div class="topbar">
            <div class="page-title">
                <h1>Cek Kondisi Akhir</h1>
                <p>Upload foto dan catatan kondisi mobil setelah customer mengajukan pengembalian.</p>
            </div>
        </div>
            ...
            <table class="table">
                ...
                while ($row = sqlsrv_fetch_array($data, SQLSRV_FETCH_ASSOC)) {
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="upload_kondisi_akhir.php?id=<?= $row['id_peminjaman']; ?>" class="btn">
